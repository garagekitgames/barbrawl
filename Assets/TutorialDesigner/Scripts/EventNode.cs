...
namespace TutorialDesigner
{
	...
	public class EventNode : Node {
		...
		public override void Init() {			
			...
			// If this was copied, there may be more triggers already
			if (triggerName.Count > 1) {
				for (int i = 1; i < triggerName.Count; i++) {
					Connector con = ScriptableObject.CreateInstance<Connector> ();
					con.Init(ConCorner.top_right, new Rect(0f, 0f, 18f, 15f), this, false);
					connectors.Add (con);
				}
			}
