...
[RequireComponent(typeof(CharacterSimpleHitMissTracker))]
[RequireComponent(typeof(CharacterBasicAI))]
...
public class AddEnemyUnityEventsScript : MonoBehaviour {
    ...
    public CharacterBasicAI characterBasicAI;
    public CharacterHealth characterHealth;
    public CharacterSimpleHitMissTracker characterHitMissTracker;
    ...
    void UpdateInspector()
    {
        ...
        playerDamaged = (GameEvent)AssetDatabase.LoadAssetAtPath("Assets/_MyStuff/Scripts/Scriptables/Event/EnemyDamaged.asset", typeof(GameEvent));
        playerDead = (GameEvent)AssetDatabase.LoadAssetAtPath("Assets/_MyStuff/Scripts/Scriptables/Event/EnemyDead.asset", typeof(GameEvent));
        playerHit = (GameEvent)AssetDatabase.LoadAssetAtPath("Assets/_MyStuff/Scripts/Scriptables/Event/EnemyHit.asset", typeof(GameEvent));
        playerMiss = (GameEvent)AssetDatabase.LoadAssetAtPath("Assets/_MyStuff/Scripts/Scriptables/Event/EnemyMiss.asset", typeof(GameEvent));
        ...
        characterHitMissTracker = GetComponent<CharacterSimpleHitMissTracker>();
        characterBasicAI = GetComponent<CharacterBasicAI>();
        ...
        UnityAction<bool> methodDelegateSetStopDoing2AI = System.Delegate.CreateDelegate(typeof(UnityAction<bool>), characterBasicAI, "SetStopDoingShit") as UnityAction<bool>;
        UnityEditor.Events.UnityEventTools.AddBoolPersistentListener(characterHealth.OnEnableEvent, methodDelegateSetStopDoing2AI, false);
        ...
        //script.Events = new UnityEvent();
        UnityAction<bool> methodDelegateSetStopDoingAI = System.Delegate.CreateDelegate(typeof(UnityAction<bool>), characterBasicAI, "SetStopDoingShit") as UnityAction<bool>;
        UnityEditor.Events.UnityEventTools.AddBoolPersistentListener(characterHealth.DeathEvent, methodDelegateSetStopDoingAI, true);

        //script.Events = new UnityEvent();
        UnityAction<float> methodDelegateDisableAfterX = System.Delegate.CreateDelegate(typeof(UnityAction<float>), characterDisable, "DisableAfter") as UnityAction<float>;
        UnityEditor.Events.UnityEventTools.AddFloatPersistentListener(characterHealth.DeathEvent, methodDelegateDisableAfterX, 2);
