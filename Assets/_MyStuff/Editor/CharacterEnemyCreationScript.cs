...
public class CharacterEnemyCreationScript : ScriptableWizard
{
    ...
    public CharacterRuntimeSet defaultPlayerRuntimeSet;

    private CharacterAction[] defaultLoosePlayerCharacterActions = new CharacterAction[5];
    private CharacterAction[] defaultTightPlayerCharacterActions = new CharacterAction[5];

   // private CharacterRuntimeSet enemyRuntimeSet = new CharacterRuntimeSet();
    ...
    private LegsConfig defaultFastLegConfig;
    ...
    private void OnEnable()
    {
        ...
        defaultPlayerRuntimeSet = (CharacterRuntimeSet)AssetDatabase.LoadAssetAtPath("Assets/_MyStuff/Scripts/Scriptables/Sets/EnemyCharacterRuntimeSet.asset", typeof(CharacterRuntimeSet));
        ...
        defaultLoosePlayerCharacterActions[0] = (CharacterAction)AssetDatabase.LoadAssetAtPath("Assets/_MyStuff/Scripts/Scriptables/Actions/NewActions/PlayerCharacterMoveActionOutputAI.asset", typeof(CharacterAction));
        defaultLoosePlayerCharacterActions[1] = (CharacterAction)AssetDatabase.LoadAssetAtPath("Assets/_MyStuff/Scripts/Scriptables/Actions/NewActions/PlayerCharacterLegsInput.asset", typeof(CharacterAction));
        defaultLoosePlayerCharacterActions[2] = (CharacterAction)AssetDatabase.LoadAssetAtPath("Assets/_MyStuff/Scripts/Scriptables/Actions/NewActions/PlayerSetDirectionOutputLooseGuy.asset", typeof(CharacterAction));
        ...
        defaultLoosePlayerCharacterActions[3] = (CharacterAction)AssetDatabase.LoadAssetAtPath("Assets/_MyStuff/Scripts/Scriptables/Actions/NewActions/PlayerCharacterSimpleAttackOutputAI.asset", typeof(CharacterAction));
        ...
        defaultLoosePlayerCharacterActions[4] = (CharacterAction)AssetDatabase.LoadAssetAtPath("Assets/_MyStuff/Scripts/Scriptables/Actions/NewActions/PlayerCharacterSetDirectionInputAI.asset", typeof(CharacterAction));

        //defaultLoosePlayerCharacterActions[0] = (CharacterAction)AssetDatabase.LoadAssetAtPath("Assets/_MyStuff/Scripts/Scriptables/Actions/NewActions/PlayerCharacterMoveActionInput.asset", typeof(CharacterAction));
        defaultTightPlayerCharacterActions[0] = (CharacterAction)AssetDatabase.LoadAssetAtPath("Assets/_MyStuff/Scripts/Scriptables/Actions/NewActions/PlayerCharacterMoveActionOutputAI.asset", typeof(CharacterAction));
        defaultTightPlayerCharacterActions[1] = (CharacterAction)AssetDatabase.LoadAssetAtPath("Assets/_MyStuff/Scripts/Scriptables/Actions/NewActions/PlayerCharacterLegsInput.asset", typeof(CharacterAction));
        defaultTightPlayerCharacterActions[2] = (CharacterAction)AssetDatabase.LoadAssetAtPath("Assets/_MyStuff/Scripts/Scriptables/Actions/NewActions/PlayerSetDirectionOutput.asset", typeof(CharacterAction));
        //defaultLoosePlayerCharacterActions[4] = (CharacterAction)AssetDatabase.LoadAssetAtPath("Assets/_MyStuff/Scripts/Scriptables/Actions/NewActions/PlayerCharacterAttackInput.asset", typeof(CharacterAction));
        defaultTightPlayerCharacterActions[3] = (CharacterAction)AssetDatabase.LoadAssetAtPath("Assets/_MyStuff/Scripts/Scriptables/Actions/NewActions/PlayerCharacterSimpleAttackOutputAI.asset", typeof(CharacterAction));
        //defaultLoosePlayerCharacterActions[6] = (CharacterAction)AssetDatabase.LoadAssetAtPath("Assets/_MyStuff/Scripts/Scriptables/Actions/NewActions/PlayerCharacterSetTargetTouchInput.asset", typeof(CharacterAction));
        defaultTightPlayerCharacterActions[4] = (CharacterAction)AssetDatabase.LoadAssetAtPath("Assets/_MyStuff/Scripts/Scriptables/Actions/NewActions/PlayerCharacterSetDirectionInputAI.asset", typeof(CharacterAction));
        ...
        //Default Attacks
        defaultLoosePlayerCharacterAttacks[0] = (AttackData)AssetDatabase.LoadAssetAtPath("Assets/_MyStuff/Scripts/Scriptables/AttackData/LooseGuyAI/BasicLeftKick 1.asset", typeof(AttackData));
        defaultLoosePlayerCharacterAttacks[1] = (AttackData)AssetDatabase.LoadAssetAtPath("Assets/_MyStuff/Scripts/Scriptables/AttackData/LooseGuyAI/BasicLeftKickFront 1.asset", typeof(AttackData));
        defaultLoosePlayerCharacterAttacks[2] = (AttackData)AssetDatabase.LoadAssetAtPath("Assets/_MyStuff/Scripts/Scriptables/AttackData/LooseGuyAI/BasicRightKick 1.asset", typeof(AttackData));
        defaultLoosePlayerCharacterAttacks[3] = (AttackData)AssetDatabase.LoadAssetAtPath("Assets/_MyStuff/Scripts/Scriptables/AttackData/LooseGuyAI/BasicRightKickFront 1.asset", typeof(AttackData));
        defaultLoosePlayerCharacterAttacks[4] = (AttackData)AssetDatabase.LoadAssetAtPath("Assets/_MyStuff/Scripts/Scriptables/AttackData/LooseGuyAI/BasicLeftPunch 1.asset", typeof(AttackData));
        defaultLoosePlayerCharacterAttacks[5] = (AttackData)AssetDatabase.LoadAssetAtPath("Assets/_MyStuff/Scripts/Scriptables/AttackData/LooseGuyAI/BasicRightPunch 1.asset", typeof(AttackData));
        defaultLoosePlayerCharacterAttacks[6] = (AttackData)AssetDatabase.LoadAssetAtPath("Assets/_MyStuff/Scripts/Scriptables/AttackData/LooseGuyAI/BasicLeftPunchFromHip 1.asset", typeof(AttackData));
        defaultLoosePlayerCharacterAttacks[7] = (AttackData)AssetDatabase.LoadAssetAtPath("Assets/_MyStuff/Scripts/Scriptables/AttackData/LooseGuyAI/BasicRightPunchFromHip 1.asset", typeof(AttackData));

        defaultTightPlayerCharacterAttacks[0] = (AttackData)AssetDatabase.LoadAssetAtPath("Assets/_MyStuff/Scripts/Scriptables/AttackData/AIAttacks/BasicLeftKick.asset", typeof(AttackData));
        defaultTightPlayerCharacterAttacks[1] = (AttackData)AssetDatabase.LoadAssetAtPath("Assets/_MyStuff/Scripts/Scriptables/AttackData/AIAttacks/BasicLeftKickFront.asset", typeof(AttackData));
        defaultTightPlayerCharacterAttacks[2] = (AttackData)AssetDatabase.LoadAssetAtPath("Assets/_MyStuff/Scripts/Scriptables/AttackData/AIAttacks/BasicRightKick.asset", typeof(AttackData));
        defaultTightPlayerCharacterAttacks[3] = (AttackData)AssetDatabase.LoadAssetAtPath("Assets/_MyStuff/Scripts/Scriptables/AttackData/AIAttacks/BasicRightKickFront.asset", typeof(AttackData));
        defaultTightPlayerCharacterAttacks[4] = (AttackData)AssetDatabase.LoadAssetAtPath("Assets/_MyStuff/Scripts/Scriptables/AttackData/AIAttacks/BasicLeftPunch.asset", typeof(AttackData));
        defaultTightPlayerCharacterAttacks[5] = (AttackData)AssetDatabase.LoadAssetAtPath("Assets/_MyStuff/Scripts/Scriptables/AttackData/AIAttacks/BasicRightPunch.asset", typeof(AttackData));
        defaultTightPlayerCharacterAttacks[6] = (AttackData)AssetDatabase.LoadAssetAtPath("Assets/_MyStuff/Scripts/Scriptables/AttackData/AIAttacks/BasicLeftPunchFromHip.asset", typeof(AttackData));
        defaultTightPlayerCharacterAttacks[7] = (AttackData)AssetDatabase.LoadAssetAtPath("Assets/_MyStuff/Scripts/Scriptables/AttackData/AIAttacks/BasicRightPunchFromHip.asset", typeof(AttackData));
        ...
        defaultFastLegConfig = (LegsConfig)AssetDatabase.LoadAssetAtPath("Assets/_MyStuff/Scripts/Scriptables/LegConfigs/LegsConfig20KGAI.asset", typeof(LegsConfig));
        ...
        difficultyMultiplier = (FloatVariable)AssetDatabase.LoadAssetAtPath("Assets/_MyStuff/Scripts/Scriptables/Variables/difficultyMultiplier.asset", typeof(FloatVariable));
        ...
        windUpPrefab = AssetDatabase.LoadAssetAtPath("Assets/_MyStuff/ParticleEffects/CFX4_Rays_1.prefab", (typeof(GameObject))) as GameObject;
        bloodFXPrefab = AssetDatabase.LoadAssetAtPath("Assets/SimpleFX/Prefabs/FX_BloodSplatter.prefab", (typeof(GameObject))) as GameObject;
        ...
        damageEffectMaterial = (Material)AssetDatabase.LoadAssetAtPath("Assets/DamageEffect/Materials/3D/ArcadeDamage3D.mat", typeof(Material));
   ...
   public GameEvent playerMiss;*/
    ...
    {
        ScriptableWizard.DisplayWizard<CharacterEnemyCreationScript>("Create Enemy", "Create Loose Enemy", "Create Tight Enemy");
    }
    ...
    void OnWizardCreate()
    {
        ...
        if (!characterGO.transform.GetComponent<CharacterThinker>())
        {
           ...
           // characterThinker.RuntimeSet = 
            characterThinker.canBeHurt = true;
            characterThinker.timeBetweenGettingHurt = 0;
            ...
            characterThinker.teamID = 2;
            characterThinker.amIMainPlayer = false;
        ...
        if (!characterGO.transform.GetComponent<CharacterBasicAI>())
        {
            CharacterBasicAI characterBasic = characterGO.AddComponent<CharacterBasicAI>() as CharacterBasicAI;
            characterBasic.target = targetPoint;
            characterBasic.difficultyMultiplier = difficultyMultiplier;
            characterBasic.rootBodyPart = Hip;
            characterBasic.attackDistance = 1.5f;
            characterBasic.attackSpeed = 0.5f;
            characterBasic.chargeTimePerDistance.minValue = 0.5f;
            characterBasic.chargeTimePerDistance.maxValue = 0.75f;
            characterBasic.timeBetweenShots.minValue = 0.2f;
            characterBasic.timeBetweenShots.maxValue = 2f;
            characterBasic.attackDelay = 0.7f;
        ...
        if (!characterGO.transform.GetComponent<CharacterHitParticleEffect>())
        {
            CharacterHitParticleEffect characterHitParticleEffect = characterGO.AddComponent<CharacterHitParticleEffect>() as CharacterHitParticleEffect;
            characterHitParticleEffect.bodyPartToSpawnBlood = Head;
            characterHitParticleEffect.prefab = bloodFXPrefab;
            /*characterLimpSetting.bodyParts = new List<garagekitgames.BodyPart>() { Hip, Chest, Head };
            characterLimpSetting.bodyPartToFixConstraints = Hip;
            characterLimpSetting.looseCharacter = true;*/
        }

        if (!characterGO.transform.GetComponent<CharacterSimpleHitMissTracker>())
        {
            CharacterSimpleHitMissTracker hitMissTracker = characterGO.AddComponent<CharacterSimpleHitMissTracker>() as CharacterSimpleHitMissTracker;
        ...
        if (!characterGO.transform.GetComponent<CharacterHealth>())
        {
            ...
            CharacterBasicAI characterBasic = characterGO.GetComponent<CharacterBasicAI>() as CharacterBasicAI;
            if (!characterGO.transform.GetComponent<CharacterLimpSetting>())
            {
        ...
        {
            childTransform.gameObject.layer = 14;
    ...
    void OnWizardOtherButton()
    {
        ...
        if (!characterGO.transform.GetComponent<CharacterThinker>())
        {
            ...
            characterThinker.legConfig = defaultFastLegConfig;
