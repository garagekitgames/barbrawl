...
{
    [CreateAssetMenu(menuName = "GarageKitGames/Actitons/PlayerMovementActionInputDirectInput")]
    public class PlayerCharacterMoveActionInputDirectInput : CharacterAction
    {
        /*[Serializable]
       ...
       // public bool enableDrag;
        ...
        public override void OnUpdate(CharacterThinker character)
        {
            ...
            inputDirection = new Vector3(Input.GetAxisRaw("L_XAxis_" + (character.input.controllerID + 1)), -Input.GetAxisRaw("L_YAxis_" + (character.input.controllerID + 1)), 0);
